...
export default function Navigation({
  ...
  const hasDesktopNavigation = showNavigationLinks || showGetQuoteButton;
  const hasMobileMenu = showNavigationLinks || showGetQuoteButton;
    ...
    <header className="sticky top-0 z-50">
      <div className="hidden md:block bg-gradient-to-r from-primary via-secondary to-primary text-white">
        <div className="max-w-7xl mx-auto px-6 py-2 flex items-center justify-between text-sm">
          ...
          <div className="flex items-center gap-6">
            <a href="tel:+18339400234" className="flex items-center gap-2 font-semibold hover:text-blue-100 transition-colors">
              <Phone className="w-4 h-4" /> (833) 940-0234
            </a>
            <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20 gap-4">
              ...
              <div className="hidden md:flex flex-1 items-center justify-end gap-4 lg:gap-6 xl:gap-10">
                ...
                {showGetQuoteButton && (
                  <>
                    {showNavigationLinks && (
                      <div
                        className="hidden lg:block h-10 w-px bg-gradient-to-b from-transparent via-blue-200 to-transparent"
                        aria-hidden
                      />
                    )}
                    <Button
            ...
            <div className="md:hidden flex items-center gap-4">
              <a href="tel:+18339400234" className="hidden sm:flex items-center gap-2 text-sm font-semibold text-primary">
