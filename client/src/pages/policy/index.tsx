          ...
          <Card className="shadow-xl border-blue-100 bg-white">
            <CardContent className="p-8 space-y-6">
              ...
              <div className="rounded-xl bg-blue-50 border border-blue-100 p-4 text-sm text-primary">
                Need help comparing coverage? Call <a className="font-semibold" href="tel:+18339400234">(833) 940-0234</a> and our concierge team will walk through the policy with you.
              </div>
            </CardContent>
          </Card>
        </section>
